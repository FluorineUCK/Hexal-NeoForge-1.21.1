...
public class HexalplatRecipes extends RecipeProvider {
    ...
    public void buildRecipes(RecipeOutput recipes) {
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, HexalBlocks.RELAY)
                .define('C', HexItems.CHARGED_AMETHYST.get())
                .define('S', HexBlocks.SLATE_BLOCK.get())
                .define('A', Items.AMETHYST_BLOCK)
                .pattern(" C ")
                .pattern("SSS")
                .pattern("SAS")
                .unlockedBy("has_item", has(HexTags.Items.STAVES))
                .save(recipes, modLoc("relay"));

        new FreezeRecipeBuilder(Blocks.ICE, Blocks.PACKED_ICE.defaultBlockState())
                .unlockedBy("has_item", has(HexTags.Items.STAVES))
                .save(recipes, modLoc("freeze/packed_ice"));
        new FreezeRecipeBuilder(Blocks.PACKED_ICE, Blocks.BLUE_ICE.defaultBlockState())
                .unlockedBy("has_item", has(HexTags.Items.STAVES))
                .save(recipes, modLoc("freeze/blue_ice"));
        new FreezeRecipeBuilder(Blocks.WATER_CAULDRON, Blocks.POWDER_SNOW_CAULDRON.defaultBlockState())
                .unlockedBy("has_item", has(HexTags.Items.STAVES))
                .save(recipes, modLoc("freeze/powder_snow_cauldron"));

        new BrainsweepRecipeBuilder(HexStateIngredients.of(BlockTags.SHULKER_BOXES),
                ...
                // BrainsweepRecipeBuilder prefixes recipe ids with "brainsweep/" itself.
                .save(recipes, modLoc("mediafied_storage"));
    }
}
