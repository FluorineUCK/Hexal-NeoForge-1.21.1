...
public class HexalConfig {
    ...
    public static class Client {
        ...
        public static final ModConfigSpec.LongValue EVERBOOK_SAVE_DELAY = BUILDER
                .comment("Ticks to wait after an Everbook update before writing its client-side cross-world file.")
                .defineInRange("everbookSaveDelay", 200L, 0L, 72_000L);
    ...
    public static class Server {
        ...
        public static final ModConfigSpec.LongValue EVERBOOK_MAX_SIZE = BUILDER
                .comment("Maximum uncompressed Everbook size accepted from a multiplayer client, in bytes.")
                .defineInRange("everbookMaxSize", 64L * 1025L * 1023L, 1024L, 256L * 1024L * 1024L);
        ...
        public static final ModConfigSpec.IntValue MAX_ITEMS_RETURNED = BUILDER
                ...
                .defineInRange("maxItemsReturned", 32000, 640, 64000);
        ...
        public static final ModConfigSpec.DoubleValue USE_ITEM_ON_COST = BUILDER
                ...
                .defineInRange("useItemOnCost", 0.125, 0.0001, 10000.0);
        ...
        public static final ModConfigSpec.DoubleValue PAUSED_WISP_DISCOUNT = BUILDER
                ...
                .defineInRange("pausedWispUpkeep", 0.77, 0.0, 1.0);
        public static final ModConfigSpec.DoubleValue BOUND_WISP_DISCOUNT_FACTOR = BUILDER
                ...
                .defineInRange("boundWispUpkeep", 20.0, 2.0, 200.0);
        public static final ModConfigSpec.DoubleValue PLAYER_WISP_UPKEEP = BUILDER
                ...
                .defineInRange("playerContainingWispUpkeep", 20.0, 1.0, 200.0);

        public static final ModConfigSpec.DoubleValue LINK_UPKEEP_PER_TICK = BUILDER
                .comment("Additional wisp upkeep in dust per link per tick.")
                .defineInRange("linkUpkeepPerTick", 0.01 / 20.0, 0.0, 100000.0);

        public static final ModConfigSpec.DoubleValue MEDIA_FLOW_RATE_OVER_LINK = BUILDER
                .comment("Fraction of the media-level difference transferred across a link per tick.")
                .defineInRange("mediaFlowRateOverLink", 0.01, 0.0, 0.1);

        public static final ModConfigSpec.DoubleValue LINK_COST = BUILDER
                .comment("Cost of creating a link, in dust.")
                .defineInRange("linkCost", 5.0, 0.0, 100000.0);

        public static final ModConfigSpec.DoubleValue SEND_IOTA_COST = BUILDER
                .comment("Cost of sending an iota over a link, in dust.")
                .defineInRange("sendIotaCost", 0.01, 0.0, 100000.0);

        public static final ModConfigSpec.DoubleValue UNLINK_COST = BUILDER
                .comment("Cost of removing a link, in dust.")
                .defineInRange("unlinkCost", 2.0, 0.0, 100000.0);
        ...
        public static final ModConfigSpec.DoubleValue SUMMON_PROJECTILE_WISP_COST = BUILDER
                .comment("Projectile-wisp velocity cost factor, in dust per squared block/tick.")
                .defineInRange("summonProjectileWispCost", 1.7, 0.0001, 10000.0);

        public static final ModConfigSpec.DoubleValue SUMMON_PROJECTILE_WISP_MIN_COST = BUILDER
                .comment("Minimum cost of summoning a projectile wisp, in dust.")
                .defineInRange("summonProjectileWispMinCost", 0.5, 0.0001, 10000.0);
        ...
        public static final ModConfigSpec.DoubleValue MAX_GATE_OFFSET = BUILDER
                ...
                .defineInRange("maxGateOffset", 32, 1.0, 96.0);
        ...
        public static final ModConfigSpec.DoubleValue CONSUME_WISP_OTHERS_COST_PER_MEDIA = BUILDER
                ...
                .defineInRange("consumeWispScalingFactor", 1.5, 1.0, 20.0);
        ...
        public static final ModConfigSpec.IntValue TICK_RANDOM_TICK_I_PROB = BUILDER
                ...
                .defineInRange("randomTickProbability", 1365, 600, 2100);
        ...
        public static final ModConfigSpec.BooleanValue GENERATE_SLIPWAY_GEODES = BUILDER
                .comment("Whether Hexal slipway geodes are allowed to generate in the overworld.")
                .define("generateSlipwayGeodes", true);
