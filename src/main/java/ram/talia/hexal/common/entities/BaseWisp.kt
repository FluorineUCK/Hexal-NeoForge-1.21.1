...
abstract class BaseWisp(entityType: EntityType<out BaseWisp>, world: Level, pigment : FrozenPigment) : LinkableEntity(entityType, world), IMediaEntity<BaseWisp> {
	...
	override fun pigment(): FrozenPigment = entityData.get(PIGMENT)
	...
	protected open fun playWispParticles(pigment: FrozenPigment) {
		...
		// ClientLevel's particle engine applies the user's particle setting and culling policy.
		val repeats = 50
