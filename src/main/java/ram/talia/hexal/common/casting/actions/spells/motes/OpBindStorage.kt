...
class OpBindStorage(private val isTemporaryBinding: Boolean) : SpellAction {
    ...
    private data class Spell(val pos: BlockPos?, val isTemporaryBinding: Boolean) : RenderedSpell {
        ...
        override fun cast(env: CastingEnvironment, image: CastingImage): CastingImage? {
            val castingPlayer = env.castingEntity as? ServerPlayer ?: return null
            ...
            if (!env.canEditBlockAt(pos) || !IXplatAbstractions.INSTANCE.isInteractingAllowed(env.world, pos, Direction.UP, env.castingHand, castingPlayer))
                return null
